                ...
                <AnimatePresence>
                  {players.map((player, index) => (
                    <motion.div
                      ...
                      className="flex items-center gap-2 px-3 py-2 bg-[#1A1F35]/50 rounded-full border border-[#6366F1]/20 hover:border-[#6366F1]/40 transition-all group"
                    >
                      {/* Avatar Pill */}
                      {player.avatarUrl ? (
                        <div className="w-8 h-8 rounded-full overflow-hidden ring-2 ring-[#6366F1]/30 shadow-md shrink-0">
                          <img
                        ...
                        <div className="w-8 h-8 rounded-full bg-linear-to-br from-[#6366F1] to-[#22D3EE] flex items-center justify-center text-white font-bold text-sm shadow-md shrink-0">
